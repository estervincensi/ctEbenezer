...
--RESIDENTES
insert into ctebenezer.residente (id, data_entrada, data_nascimento, data_saida, estado_civil, naturalidade, nome, observacoes, profissao, responsavel, endereco_id) values (1,TIMESTAMP '2017-06-01 00:00:00.0', TIMESTAMP '1995-04-02 00:00:00.0', TIMESTAMP '2017-06-18 00:00:00.0','CASADO','canoas','joão','teste','autonomo','paulo',1);
insert into ctebenezer.residente (id, data_entrada, data_nascimento, data_saida, estado_civil, naturalidade, nome, observacoes, profissao, responsavel, endereco_id) values (2,TIMESTAMP '2017-05-01 00:00:00.0', TIMESTAMP '1995-04-02 00:00:00.0', null ,'CASADO','porto alegre','aldair','teste','autonomo','pedro',1);
